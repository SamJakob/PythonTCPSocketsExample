...
# Uses fixes to serialization and deserialization for Python 3.7+ from:
...
class Queue(multiprocessing.queues.Queue):
    ...
    def __getstate__(self):
        """Adds our new size property to the serialization method."""
        return {
    ...
    def __setstate__(self, state):
        """Adds our new size property to the deserialization method."""
